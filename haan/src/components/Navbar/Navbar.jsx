    ...
    return(
        ...
        <nav>
            <ul className='list'>
                ...
                <li className='items' ><Link to='/best_seller' style={{textDecoration:"none", color:'black'}}>Best Seller</Link></li>
                <li className='items'><Link  to='/product' style={{textDecoration:"none", color:'black'}}>Hand Sanitizer</Link></li>
                <li className='items'><Link  style={{textDecoration:"none", color:'black'}}>Refills</Link></li>
                <li className='items'><Link to='/'><img src='https://haanready.com/cdn/shop/files/logo_han.png?v=1651046048' alt='logo' /></Link></li>
                <li className='items'><Link  style={{textDecoration:"none", color:'black'}}>Toothpaste</Link></li>
                <li className='items'><Link  style={{textDecoration:"none", color:'black'}}>Hand Soap</Link></li>
                <li className='items'><Link  style={{textDecoration:"none", color:'black'}}>Combos</Link></li>
